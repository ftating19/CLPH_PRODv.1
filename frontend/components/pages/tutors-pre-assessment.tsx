...
export default function TutorsPreAssessment() {
  ...
  const fetchPreAssessments = async () => {
    try {
      ...
      const response = await fetch(`https://api.cictpeerlearninghub.com/api/tutor-pre-assessments?created_by=${currentUser?.user_id}`)
  ...
  const handleCreatePreAssessment = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api.cictpeerlearninghub.com/api/tutor-pre-assessments', {
        method: 'POST',
        headers: {
  ...
  const handleUpdatePreAssessment = async () => {
    ...
    try {
      setIsSubmitting(true)
      const response = await fetch(`https://api.cictpeerlearninghub.com/api/tutor-pre-assessments/${selectedPreAssessment.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const fetchQuestions = async (preAssessmentId: number) => {
    try {
      ...
      const response = await fetch(`https://api.cictpeerlearninghub.com/api/tutor-pre-assessment-questions/pre-assessment/${preAssessmentId}?t=${timestamp}`)
  ...
  const handleSaveQuestion = async () => {
    ...
    try {
      ...
      let response
      if (editingQuestion) {
        response = await fetch(`https://api.cictpeerlearninghub.com/api/tutor-pre-assessment-questions/${editingQuestion.id}`), {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(requestData)
        }
      } else {
        response = await fetch('https://api.cictpeerlearninghub.com/api/tutor-pre-assessment-questions', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(requestData)
        })
  ...
  const handleDeleteQuestion = async (questionId: number) => {
    try {
      setIsSubmitting(true)
      const response = await fetch(`https://api.cictpeerlearninghub.com/api/tutor-pre-assessment-questions/${questionId}`, {
        method: 'DELETE'
      })
