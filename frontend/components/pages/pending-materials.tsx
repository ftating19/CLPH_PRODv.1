...
export default function PendingMaterials() {
  ...
  const fetchPendingMaterials = async () => {
    try {
      setLoading(true)
      setError(null)
      const response = await fetch('https://api.cictpeerlearninghub.com/api/pending-materials/status/pending')
      if (!response.ok) {
  ...
  const confirmApproval = async () => {
    ...
    try {
      const response = await fetch(`https://api.cictpeerlearninghub.com/api/pending-materials/${currentMaterial.material_id}/approve`, {
        method: 'PUT',
        headers: {
  ...
  const confirmRejection = async () => {
    ...
    try {
      const response = await fetch(`https://api.cictpeerlearninghub.com/api/pending-materials/${currentMaterial.material_id}/reject`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
