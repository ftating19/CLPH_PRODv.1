...
export default function DiscussionForums() {
  ...
  React.useEffect(() => {
    ...
    fetch(`https://api.cictpeerlearninghub.com/api/forums${userIdParam}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  React.useEffect(() => {
    ...
    fetch(`https://api.cictpeerlearninghub.com/api/forums/${selectedForumId}/comments`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleSubmitEdit = async () => {
    ...
    try {
      const res = await fetch(`https://api.cictpeerlearninghub.com/api/forums/${editingForum.forum_id}`, {
        method: 'PUT',
      ...
      if (res.ok) {
        ...
        const forumsRes = await fetch(`https://api.cictpeerlearninghub.com/api/forums?user_id=${currentUser.user_id}`);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const res = await fetch(`https://api.cictpeerlearninghub.com/api/forums/${deletingForum.forum_id}?user_id=${currentUser.user_id}`, {
        method: 'DELETE'
      });
            ...
            <div className="flex justify-end space-x-3 mt-6 pt-4 border-t">
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  const res = await fetch("https://api.cictpeerlearninghub.com/api/forums", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
                      title: newTopicTitle,
            ...
            <div className="flex gap-4 pt-2 border-t mt-2">
              <Button
                ...
                onClick={async () => {
                  ...
                  const res = await fetch(`https://api.cictpeerlearninghub.com/api/forums/${forum.forum_id}/like`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      const res = await fetch(`https://api.cictpeerlearninghub.com/api/forums/${selectedForumId}/comments`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
