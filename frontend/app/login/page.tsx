...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://api.cictpeerlearninghub.com/api/login', {
        method: 'POST',
        headers: {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 flex items-center justify-center p-6">
        ...
        <div className="flex-1 flex items-center justify-center p-4 lg:p-6">
          <div className="w-full max-w-xl">
            <Card className="shadow-lg border-0 bg-white h-full max-h-[700px] min-h-[600px] flex flex-col">
