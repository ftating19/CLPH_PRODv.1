...
CREATE TABLE IF NOT EXISTS pre_assessment_questions (
  ...
  subject_id INT NULL,                      -- Link question to specific subject
...
CREATE INDEX IF NOT EXISTS idx_pre_assessment_questions_subject_id ON pre_assessment_questions(subject_id);
